...
public class Recursion234Runner
{
	public static void main(String args[])
	{
		...
		System.out.println(RecursionFunOne.countOddDigits(31332));
		System.out.println(RecursionFunOne.countOddDigits(3113));
		System.out.println(RecursionFunOne.countOddDigits(13331));
		System.out.println(RecursionFunOne.countOddDigits(777337777));
		//add more test cases
	}
}