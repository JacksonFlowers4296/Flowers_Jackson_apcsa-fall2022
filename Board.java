...
public abstract class Board {
	 ...
	 */
	public int deckSize(int l, int dealt) {
		return deck.size(l, dealt);
	}
	 ...
	 *         false otherwise.
	 */
	public boolean gameIsWon(int l, int dealt) {
		if (deck.isEmpty(l, dealt)) {
			for (Card c : cards) {
				if (c != null) {
					return false;
				}
