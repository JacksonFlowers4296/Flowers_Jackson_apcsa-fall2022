...
public class CardGameGUI extends JFrame implements ActionListener {
	 ...
	 */
	public void repaint(int l, int dealt) {
		...
		statusMsg.setText(board.deckSize(l, dealt)
	 ...
	 */
	private void initDisplay(int l, int dealt)	{
		panel = new JPanel() {
		...
		statusMsg = new JLabel(
			board.deckSize(l, dealt) + " undealt cards remain.");
		panel.add(statusMsg);
	 ...
	 */
	public void actionPerformed(ActionEvent e, int[] Deck) {
